...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDatabase
    {
        ...
        public T SingleById<T>(string v, int employeeId)
        {
            throw new NotImplementedException();
        }

        public void Insert<T>(T employee)
        {
            throw new NotImplementedException();
        }

        public T SingleById<T>(int employeeId)
        {
            throw new NotImplementedException();
        }
    ...
    public interface IDatabase : IDisposable, IQuery, IAlterPoco, IExecute, ITransactionAccessor
    {
        ...
        T SingleById<T>(int employeeId);
        void Insert<T>(T employee);
    }
